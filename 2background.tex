...
The principles presented above are essential, but too abstract in order to be used as a sole basis for defining a good visualization. \fixme{Here something more concrete about the visualizations principles.}

Tufte says hello. About 2 pages?
...
These are from \url{http://en.wikipedia.org/wiki/Thematic_map} - \fixme{find academic references for these}
