...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{An approximated choropleth map depicting ... \fixme{replace placeholder image}}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{Dasymetric map depicting land use density in San Francisco. Image courtesy of Eric Fischer. \fixme{citation}}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=8cm]{images/dot-example.jpg}
    \caption{Proportional symbol map depicting ... \fixme{replace placeholder map}}
