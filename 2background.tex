...
Also known as ``literature review''/``Kirjallisuuskatsaus''.

\section{Visualizing Geographical Data}

How to visualize data (in general, and specifically for geographical data.) Tufte and others.

\section{Something about Using Webtech for Visualization}

Probably should describe the relevant web technology, some needed HTML5/JS features etc. \fixme{This section may need to be deleted/moved to chapter 3.}
...
Here be description of the current way of visualizing data. In the later sections of this chapter \citep{mohagheghi_empirical_2008}, there should also be information about the problem, i.e. why it is currently unnecessarily laborious to create a web geovisualization. \citep{aggarwal_software_2005}
...
\emph{B+-trees offers one way to index data that is stored in to a
  ...
  possible with MVBT.~\citep{HaapasaloThesis}} When the marking is
...
direct quotes has two tricks: quotation marks and the source.  \emph{
  ...
  merged to retain optimality.''~\citep{HaapasaloThesis}} Quotes are
