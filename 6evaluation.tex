...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{Thematic.js visualization metrics for each case in relation to a corresponding reference visualization. \fixme{Is this the correct way of saying ``value in Thematic.js visualization / value in reference visualization''?}}
