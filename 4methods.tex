...
% passive, emphasizing the possibility ("this can be done by ...") instead of the actor ("evaluator")
...
% passive, emphasizing ability (can be measured) instead of actor (evaluator can measure)
...
% passive, emphasizing ability (should be complemented) instead of actor (evaluator should complement)
...
% passive, emphasizing ability (can be done) instead of actor (evaluator can do)
...
% passive, de-emphasizing actor ("majority of map visualization evaluators")
