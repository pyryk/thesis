...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Visualizing Geographical Data on the Web}
\newcommand{\FTITLE}{Geografisen datan visualisointi webissä}
...
\newcommand{\DATE}{May 28, 2014}
\newcommand{\FDATE}{28. toukokuuta 2014}
...
\newcommand{\INSTRUCTOR}{N.N. M.Sc. (Tech.)}
\newcommand{\FINSTRUCTOR}{Diplomi-insinööri N.N.}
...
\fixme{Remove ``libproxy.aalto.fi'' from all the URLs in references!}
