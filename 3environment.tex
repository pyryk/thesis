...
Describe the map visualizations that sparked the interest for this kind of research. FindBooze, Peruskartta and Ottoapp.
...
Live}~\citep{TeXLive}, which is the current default \LaTeX\ distribution for
...
site); however, I have used \emph{MiKTeX}~\citep{MiKTeX} and can recommend it
for Windows. 
...
\emph{TeXlipse}~\citep{TeXlipse} plugin for the Eclipse IDE~\citep{Eclipse}. 
