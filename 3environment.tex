...
Describe the map visualizations that sparked the interest for this kind of research. FindBooze, Peruskartta and Ottoapp. Also, reason why it is unnecessarily laborious to write map visualizations every time from scratch. \fixme{May be moved to implementation}
...
% \section{\LaTeX\ Graphics} - Not a section really, but here as an example :)
