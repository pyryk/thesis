...
\fixme{this appendix would be 20+ pages long. Is it ok to just provide a link to the full results?}

\section{Thematic.js implementations}

\subsection{Store Map}

% \lstinputlisting[language=JavaScript]{results/dot-thematic.json}
